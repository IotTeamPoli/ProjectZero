...
(function () {
	var SPARKLINE_HISTORY_LENGTH = 300;
	...
	function addValueToSparkline(element, value, legend) {
		...
		_.each(values, function(valueArray, valueIndex) {
			$(element).sparkline(valueArray, {
				...
				minSpotColor: "#78AB49",
				maxSpotColor: "#78AB49",
				highlightSpotColor: "#ff191c",
				highlightLineColor: "#f713b6",
	...
	freeboard.addStyle('.widget-big-text', valueStyle + "font-size:100px;");
